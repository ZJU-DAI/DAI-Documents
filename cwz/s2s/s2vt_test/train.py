...
def main():
    ...
    parser.add_argument('--gpu_mem', type=float, default=1.000,
...
def train(args):
    if args.init_from is not None:
        ...
        # read data
        _, _, train_feat_id, train_caption, test_feat_id, test_caption = data_preprocess(args.train_label_json,
                                                                                         args.test_label_json)
        ...
        for checkme in need_be_same:
            assert vars(saved_args)[checkme] == vars(args)[
    ...
    with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
        ...
        for epoch in range(0, args.n_epoch):
            ...
            for start, end in zip(
                ...
                current_caption, current_caption_mask = get_padding_caption(vocab, batch_caption,
                                                                            maxlen=model.n_caption_step + 1)
