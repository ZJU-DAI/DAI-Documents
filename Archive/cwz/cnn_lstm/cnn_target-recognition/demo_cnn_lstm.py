...
from modelNet.cnn_lstm_net import cnnLstmNet
...
class Detector(object):
    ...
    def __init__(self, net, weight_file):
        ...
        print('重新载入权重文件: ' + self.weights_file)
    ...
    def camera_detector(self, cap, wait=10):
        ...
        while ret:
            ...
            detect_timer.toc()
            print('平均检测时间: {:.3f}s'.format(detect_timer.average_time))
